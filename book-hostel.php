	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="left">You already booked this hostel room.</h3>
				<?php }
				else{
							echo "";
							}			
...
<div class="form-group">
<label class="col-sm-2 control-label">Fees Per Month (FPM)</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" align="left">Correspondence's Address </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-5 control-label">Permanent Address same as Correspondence's address : </label>
<div class="col-sm-4">
